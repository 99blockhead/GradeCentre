// Georgian Student Number : 200416930 - 991115
...
public class GradeCentre {
    ...
    public static float sum; //The sum of all 5 of the grades
    public static float avg = 0; //The float which will be the average of all 5 of the grades
    public static int[] gradeValue = new int[5]; //The int array that will hold the grade values (out of 100)
    public static String[] gradeName = new String[5]; //The String array that holds the name of which the grade represents
    public static String[] gradeLetter = new String[5]; //The String array that holds the letter value that corresponds to the imputed grade
    public static String avgLetter; //The String that is used to represent the letter value that goes to the overall average value
    ...
    public static void main(String[]args) {
        for(int x=0 ; x<= 4 ; x++) { //The FOR loop that makes the code go through the following until x is greater than 4 (since the count starts at 0)
            ...
            System.out.printf("%nName: " + gradeName[x]);//
            ...
            if (x == 4) {//An if statement that makes the loop go through the following when x is equal to 4 (the 5th term)
                ...
                //results 1 (x=0)
                System.out.printf("%nName: " + gradeName[0]);
                System.out.printf("%nGrade: " + gradeValue[0]);
                System.out.printf("%nLetter Grading: " + gradeLetter[0] + "%n");
                //results 2 (x=1)
                System.out.printf("%nName: " + gradeName[1]);
                System.out.printf("%nGrade: " + gradeValue[1]);
                System.out.printf("%nLetter Grading: " + gradeLetter[1] + "%n");
                //results 3 (x=2)
                System.out.printf("%nName: " + gradeName[2]);
                System.out.printf("%nGrade: " + gradeValue[2]);
                System.out.printf("%nLetter Grading: " + gradeLetter[2] + "%n");
                //results 4 (x=3)
                System.out.printf("%nName: " + gradeName[3]);
                System.out.printf("%nGrade: " + gradeValue[3]);
                System.out.printf("%nLetter Grading: " + gradeLetter[3] + "%n");
                //results 5 (x=4)
                System.out.printf("%nName: " + gradeName[4]);
                System.out.printf("%nGrade: " + gradeValue[4]);
    ...
    public static void CollectData(int y){
            ...
            System.out.printf("%n%nWhat is the name of the course/assignment #" + n + ": ");
            gradeName[y] = scan.next();//gets the inputted name to assign to the xth term
            System.out.printf("What was the grade: ");
    ...
    public static String Letter(float valueIN){
        String valueOUT; //the string that holds the value that is given back to the main method
            if (valueIN < 50) {  //if the in value is less than 50 it is assigned F
                ...
                valueOUT = ("D"); }
            else if (valueIN >= 60 & valueIN < 75) {//the else if statement which assigns the values that meet the criteria as a C
                valueOUT = ("C"); }
            else if (valueIN >= 75 & valueIN < 85) {//the else if statement which assigns the values that meet the criteria as a B
                valueOUT = ("B"); }
            else if (valueIN >= 85 & valueIN <= 100) { //the else if statement which assigns the values that meet the criteria as a A
                valueOUT = ("A"); }
